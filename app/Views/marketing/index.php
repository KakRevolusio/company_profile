...
<?php include(APPPATH . 'Views/navdanfoot/navbar.php'); ?>
    <div class="row">
        <div class="col bg-danger text-white">
            Beranda -> Tentang kami -> Defisi Bagian  -> Marketing
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="card rounded border-0 shadow">
                    <div class="card-body d-flex flex-column gap-3 py-5 px-4">
                        <!-- Progaming -->
                        <a href="http://localhost:8080/progamer" class="text-decoration-none">
                        ...
                        <!-- Marketing -->
                        <a href="http://localhost:8080/marketing" class="text-decoration-none  bg-danger">
                            <div class="d-flex align-items-center rounded p-2 gap-2 menu-semua">
                                <img src="./ASET/askSolid.svg" alt="">
                                <p class="fs-5 text-secondary text-light">Marketing</p>
                            </div>
                        </a>
