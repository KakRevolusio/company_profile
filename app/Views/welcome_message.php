...
<?php include(APPPATH . 'Views/navdanfoot/navbar.php'); ?>
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="./aset/gmb1.jpg" height="450" class="d-block w-100" alt="Gambar 1">
      </div>
      <div class="carousel-item">
        <img src="./aset/gmb2.jpg" height="450" class="d-block w-100" alt="Gambar 1">
      </div>
      <div class="carousel-item">
        <img src="./aset/gmb3.jpg" height="450" class="d-block w-100" alt="Gambar 1">
      </div>
    </div>
