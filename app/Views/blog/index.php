            ...
            <div class="col-md-4">
                ...
                <img src="/uploads/<?= $blog['image'] ?>" class="card-img-top" alt="<?= $blog['title'] ?>">
                    ...
                    <h5 class="card-title"><?= $blog['title'] ?></h5>
                        <button class="btn btn-primary" data-bs-toggle="collapse" data-bs-target="#collapse-<?php echo $blog['id']; ?>" aria-expanded="false" aria-controls="collapse-<?php echo $blog['id']; ?>">
                            Baca
                        </button>
                        <div class="collapse" id="collapse-<?php echo $blog['id']; ?>">
